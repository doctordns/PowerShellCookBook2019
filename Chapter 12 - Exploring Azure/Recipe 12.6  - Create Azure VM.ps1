#  Recipe 12-5 - Create new Azure VM
...
if (-not $rg) {
    ...
    $RG = New-AzureRmResourceGroup @RGHT1
...
$CloudSubnet = New-AzureRmVirtualNetworkSubnetConfig @SNHT
$GWSubnetName = 'GatewaySubnet'
$GWHT = @{
    Name          = $GWSubnetName
    AddressPrefix = $GWNet
}
$GWSubnet = New-AzureRmVirtualNetworkSubnetConfig @GWHT
...
$PackVnet = New-AzureRmVirtualNetwork @VNHT
...
$Nic = New-AzureRmNetworkInterface @NICHT
WRite-Host -Object $Nic
...
$NSGRule1 = New-AzureRmNetworkSecurityRuleConfig @NGSHT
